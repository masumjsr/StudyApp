 ...
 */
public class SpeakingFragment extends AppCompatActivity {
...
////////////////////////
    ...
    private void getVideos() {
        Query query = FirebaseDatabase.getInstance().getReference("admin").child("live").child("speaking").orderByChild("time");
